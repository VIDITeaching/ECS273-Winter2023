...
export default {
    data() {
        ...
        return {
            ...
            margin: {left: 60, right: 20, top: 20, bottom: 90} as Margin,
        }
    },
    computed: {
    ...
    methods: {
        ...
        initChart() {
            ...
            const xAxis = chartContainer.append('g')
                .attr('transform', `translate(0, ${this.size.height - this.margin.bottom+14})`)
            ...
            const points = chartContainer.append('g')
                ...
                .join('circle')
                .attr('cx', (d: ScatterPoint) => xScale(d.posX+1))
                .attr('cy', (d: ScatterPoint) => yScale(d.posY+1))
                .attr('r', 5)
            ...
            chartContainer.append('g')
                .selectAll("myLegend")
                .data<ScatterPoint>(this.clusters)
                .enter()
                .append("text")
            ...
            const title = chartContainer.append('g')
                ...
                .text('Mnist Dataset PCA') // text content
        },
    },
    watch: {
        rerender(newSize) {
