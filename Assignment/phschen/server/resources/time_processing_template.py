...
def prepare_time_template_data(plot=False) -> pd.DataFrame:
    ...
    sales = pd.read_csv('/Users/chenpohsuan/ECS273-Winter2023/Assignment/Vue-Flask-Template/server/data/time_template.csv', parse_dates=[0], index_col=0, date_parser=_parser)
