...
export default {
    ...
    methods: {
        ...
        initChart() {
            ...
            let clusters: string[] = this.clusters
            ...
            const title = chartContainer.append('g')
                ...
                .text('Drybean Dataset TSNE Projection')

            // ============ for xAxis, yAxis title =============
            const innerWidth = this.size.width - this.margin.left - this.margin.right
            const innerHeight = this.size.height - this.margin.top - this.margin.bottom

            const xAxisG = chartContainer.append('g')
                // .attr('transform', `translate(0, ${innerHeight})`)

            const yAxisG = chartContainer.append('g')
