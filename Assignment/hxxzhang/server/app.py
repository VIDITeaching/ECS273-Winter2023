...
from controller import getPie, processExample
...
def fetchExample():
    if request.method == "GET":  # handling GET request
        ...
        return resp
    elif request.method == "POST":  # handling POST request, which is only effective when ExampleWithInteractions.vue is loaded
